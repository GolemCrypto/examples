...
contract TomoSale is Ownable {

	uint public constant MAX_UNITS_PER_TRANSACTION = 5;
	uint public constant MAX_NFT_TO_SELL = 3500;
	
	uint public constant INITIAL_PRICE = 3 ether;
	uint public constant FINAL_PRICE = 0.6 ether;
	uint public constant PRICE_DROP = 0.1 ether;
	uint public constant PRICE_DROP_TIME = 5 minutes;
	uint public constant START_TIME = 1636804800;
